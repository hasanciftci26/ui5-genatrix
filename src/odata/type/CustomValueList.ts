...
import { CustomValueListSettings } from "ui5/genatrix/types/odata/type/CustomTypeSettings.types";
import LibraryBundle from "ui5/genatrix/util/LibraryBundle";

/**
 * @namespace ui5.genatrix.odata.type
 */
export default class CustomValueList extends ODataString {
    private readonly settings: CustomValueListSettings;

    constructor(settings: CustomValueListSettings) {
        super();
